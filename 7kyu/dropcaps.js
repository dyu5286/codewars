...
//Input is a string
//Output is a string
//split the string to get an array consisting of smaller strings: strArr = n.split(" ")
//for each element in array, if strArr.length > 2, strArr[i].toLowerCase() and strArr[i][0].toUpperCase()  
//return strArr.join(" ")
